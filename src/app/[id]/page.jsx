...
import { venueInfo } from "@/lib/axiosConfig";
...
import { cn, checkSourceContent } from "@/lib/utils";
...
import { rtlLang } from "@/constant/language";
...
export default function Index({ params }) {
    ...
    const { landingPage, allMenus, indexBanners, theme, error } =
    ...
    useFetch(landingPage, venueInfo, id);
    ...
    return (
        <Fragment>
            ...
            <main className="h-full w-full flex flex-col justify-between items-center overflow-x-hidden font-rabar">
                <div className="mt-16 w-full flex flex-col items-center justify-center gap-8">
                    ...
                    />
                    <div className={cn("w-3/4 max-w-[560px]", {
                        "mt-6": indexBanners?.length <= 0
                    })}>
                        <Buttons
                            venue={landingPage}
                            drawerOpen={setIsMenuListOpen}
                    ...
                    <ul className="flex flex-col gap-2">
                        {allMenus.map((menu) => (
                            ...
                            >
                                ...
                                {rtlLang.find((lang) => lang === language.language_code) ?
